...
int main(int argc, char ** argv){
    ...
    //ClientHelper myServer(9);
    ClientHelper myServer(10);
    ...
    //StreamerHelper myClient (StaInterface.GetAddress(0),9);
    //UdpClientHelper myClient (StaInterface.GetAddress(0),9);
    StreamerHelper myClient (StaInterface.GetAddress(0),10);
    ...
    uint32_t totalPacketRecv = DynamicCast<UdpServer>(serverApp.Get(0))->GetReceived();
